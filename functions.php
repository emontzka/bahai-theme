<?php
/**
 * bahai functions and definitions
 *
...
if (!function_exists('bahai_setup')):
    /**
    ...
    function bahai_setup()
    {
         ...
         * If you're building a theme based on bahai, use a find and replace
         * to change 'bahai' to the name of your theme in all the template files.
         */
        load_theme_textdomain('bahai', get_template_directory() . '/languages');
        ...
        register_nav_menus([
            ...
            'menu-2' => esc_html__('Footer', 'bahai'),
        ]);
 ...
 */
function bahai_content_width()
{
    $GLOBALS['content_width'] = apply_filters('bahai_content_width', 640);
}
add_action('after_setup_theme', 'bahai_content_width', 0);
...
add_action('wp_enqueue_scripts', 'bahai_scripts');
